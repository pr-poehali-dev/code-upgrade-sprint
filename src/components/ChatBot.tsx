...
const ORDERS: Record<string, string> = {
  ...
  "555555": `Ваш заказ был доставлен 15 минут назад нашим лучшим курьером <s>Александром Городецким</s>.`,
  "666666": `Курьер будет у вас через 66 минут, приготовьте оплату наличными 6 666 рублей.`,
};
